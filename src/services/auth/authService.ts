...
export default class AuthService {
    ...
    static async forgotPassword(forgotPasswordDto: ForgotPasswordDto): Promise<Response<null>> {
        return await apiClient.post<null>('auth/forgotPassword', forgotPasswordDto);
    }

    static async resetPassword(resetPasswordDto: ResetPasswordDto): Promise<Response<null>> {
